...
/**
 * Write a description of class VOConS1 here.
 * 
 * @author (your name) 
...
public class VOConS1 extends VOConS
{
    ...
    /**
     * Act - do whatever the VOConS1 wants to do. This method is called whenever
                ...
                if (!getObjectsInRange(25, VOTrain.class).isEmpty()){
                 if (Greenfoot.isKeyDown("t") && getX() < 1100){
                    ...
                    if (getX() >= 1100){
                        World world;
                        world = getWorld();
                        world.removeObjects(world.getObjects(VOConS1.class));
                        counter.add(5);
                    }
                }
