...
public class CCSchip extends Actor
{
    ...
    if( x == 280) { setRotation(270); setLocation(getX(), y+1 ); }
    }}
    ...
    if( x == 528 ) { setRotation(270); setLocation(getX(), y+1 ); }
    }}
    ...
    if( x == 776 ) { setRotation(270); setLocation(getX(), y+1 ); }
    }}
    ...
    if( x == 1024) { setRotation(270); setLocation(getX(), y+1 ); }
    }}
